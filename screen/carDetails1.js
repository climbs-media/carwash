...
import {Alert,Platform,Dimensions,Modal,
...
export default class CarDetails1 extends Component {
        ...
        flex:1,
         backgroundColor:'white',
          marginTop:hp('-7.5%'),
           ...
           <View showsVerticalScrollIndicator={false} style={{marginHorizontal:'4%'}}>
