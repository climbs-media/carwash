...
export default class Request5 extends Component {
         ...
         style={{width: '100%', height: '100%'}} >
          ...
          <View style={{flex:5,flexDirection:'row',paddingTop:hp('1%')}}>
               ...
               <TouchableOpacity 
                                 ...
                                 onPress={() =>this.props.navigation.navigate("chatWithWasher") }
                                   > 
          ...
          <Marker
                ...
                />
                 ...
                 <View style={{backgroundColor:'white',flex:1,
                             marginTop:hp('22.5%'), borderTopStartRadius:30,  borderTopEndRadius:30,
                              }}>
