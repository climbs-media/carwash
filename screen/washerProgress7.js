...
import {Alert,Platform,
  StyleSheet,ImageBackground,Keyboard,Dimensions,
...
export default class WasherProgress7 extends Component {
           ...
           <ScrollView showsVerticalScrollIndicator={false} style={{marginHorizontal:wp('4%')}}>
                 <View style={{alignItems:'center',marginTop:hp('1.5%')}}>
                    <Image source={require('../assets/usuarios/influencer.png')} 
                          ...
                          <Text style={{marginTop:'2%',marginBottom:hp('1%'),
                     ...
                     <View style={styles.textAreaContainer}>
                       ...
                       <View style={{alignItems:'center',marginBottom:hp('3.5%'),marginTop:hp('2%')}}>
                         <TouchableOpacity 
                                style={{width:wp('75%')}}
                                 onPress={() =>this.props.navigation.navigate("washerHistoryDetail") }
                                   >  
